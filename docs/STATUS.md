...
- **W-LP spun off:** dedicated worker brief `docs/handoff_left-panel.md` — perfect the rail + minimap across all pages + build P-02/P-06 from sources. Logo + left-panel consistency is now owned there.
